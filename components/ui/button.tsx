  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 uppercase tracking-wide",
  {
    variants: {
      variant: {
        ...
        primary: "bg-sky-400 text-primary-foreground hover:big-sky-400/90 border-sky-500 border-b-4 active:border-0",
        primaryOutline: "bg-white text-sky-500 hover:bg-slate-100",

        secondary: "bg-yellow-500 text-primary-foreground hover:big-green-500/90 border-yellow-600 border-b-4 active:border-0",
        secondaryOutline: "bg-white text-yellow-500 hover:bg-slate-100",
        
        danger: "bg-rose-500 text-primary-foreground hover:big-rose-500/90 border-rose-600 border-b-4 active:border-0",
        dangerOutline: "bg-white text-rose-500 hover:bg-slate-100",

        super: "bg-indigo-500 text-primary-foreground hover:big-indigo-500/90 border-indigo-600 border-b-4 active:border-0",
